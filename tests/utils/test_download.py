...
def test_load_example_fasta_dataset_success() -> None:
...
def test_load_example_fasta_dataset_fail() -> None:
...
@skipif_network_connection_failed
def test_load_example_genbank_dataset_success() -> None:
...
def test_load_example_genbank_dataset_fail() -> None:
...
def test_fetch_genbank_by_accid(tmp_path: Path) -> None:
